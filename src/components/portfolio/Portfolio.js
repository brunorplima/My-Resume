         ...
         <div className='portfolio d-flex flex-wrap justify-content-around'>
            <Project
               ...
               info={{
                  ...
                  summary: 'An ecommerce website for Inheritance Publications. I improved their old website turning it into a modern looking website with better user experience resulted from the capabilities of searching, filtering and sorting of all more than 9 thousand products. It is a server-side rendered website, powered by Next.js. Since its implementation the website has been easier to maintain and adapt to new changes. It uses Paypal payment system API. All the feedback received was positive.',
                  gitLink: '',
